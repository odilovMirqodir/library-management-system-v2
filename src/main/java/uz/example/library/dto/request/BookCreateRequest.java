...
@Schema(
        description = "Yangi kitob yaratish uchun request"
)
public class BookCreateRequest {

    @Schema(
            description = "Kitob ISBN raqami. 10 yoki 13 ta raqam. '-' va bo'sh joylar normalizatsiya qilinadi",
    ...
    @Schema(
            description = "Mavjud muallifning ID raqami",
            example = "1"
    )
    ...
    @Schema(
            description = "Mavjud kategoriyaning ID raqami",
            example = "1"
    )
    ...
    @Schema(
            description = "Kutubxonadagi jami kitob nusxalari soni",
            example = "5"
    )
